...
<head>
  ...
  <title><?php if (isset($datas['title'])) echo $datas['title']." | "; ?>exo-blog-005 - Materialize</title>
...
<body>
  <nav class="blue" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="<?= $baseUrl ?>/" class="brand-logo">exo-blog-005</a>
